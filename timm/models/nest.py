...
class NestLevel(nn.Module):
    ...
    def forward(self, x):
        ...
        """
        # print(x.shape)  # torch.Size([32, 96, 56, 56]), torch.Size([32, 192, 28, 28])
        x = self.pool(x)
        # print(x.shape)  # torch.Size([32, 192, 28, 28]), torch.Size([32, 384, 14, 14])
        x = x.permute(0, 2, 3, 1)  # (B, H', W', C), switch to channels last for transformer
        # print(x.shape)  torch.Size([32, 28, 28, 192]), torch.Size([32, 14, 14, 384])
        x = blockify(x, self.block_size)  # (B, T, N, C'), N is number of tokens in a patch
        # print(x.shape)  torch.Size([32, 4, 196, 192])  torch.Size([32, 1, 196, 384])
        x = x + self.pos_embed
        x = self.transformer_encoder(x)  # (B, T, N, C')
        # print(x.shape)  torch.Size([32, 4, 196, 192])  torch.Size([32, 1, 196, 384])
        x = deblockify(x, self.block_size)  # (B, H', W', C')
        # print(x.shape, x.permute(0, 3, 1, 2).shape)  torch.Size([32, 28, 28, 192]), torch.Size([32, 192, 28, 28])  torch.Size([32, 14, 14, 384]),torch.Size([32, 384, 14, 14])
...
class Nest(nn.Module):
    ...
    def forward_features(self, x):
        ...
        # print(x.shape)  torch.Size([32, 96, 56, 56])  each grid contains 4x4 pixels, no flatten
        x = self.levels(x)
        # print(x.shape)  torch.Size([32, 384, 14, 14])
